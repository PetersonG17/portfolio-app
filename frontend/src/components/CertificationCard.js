    ...
    return (
        <div className="card bg-light mb-3">
            ...
            <div className="card-body">
                ...
                <div className="card-body">
                    <a href="https://www.credly.com/badges/c07d8c41-6523-4d4f-809d-c06e5685ca60?source=linked_in_profile" className="btn btn-secondary text-white"><i className="far fa-check-circle pe-1"></i>Verify</a>
                </div>
            </div>
        </div>
    );
